<%-- 
    Document   : include
    Created on : 11/01/2010, 01:36:11 PM
    Author     : esmata
    This file contains the template jsp that is going to be used through tiles
--%>
...
<script src="${pageContext.request.contextPath}/javascript/yui/autocomplete/autocomplete-min.js" type="text/javascript" language="javascript"></script>
