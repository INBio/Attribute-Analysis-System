...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function verifyMapping(){
                ...
                var cname = document.getElementById('scientific_name');
                if(cid.value != 'unmapped' && cname.value != 'unmapped' && iid.value != 'unmapped'){
                    form.submit();
                }
                else{
    ...
    <body>
        ...
        <div id="contenido">
            ...
            <div id="content">
                <h2><fmt:message key="tic_mapping"/></h2><br>
                    ...
                    <div id="configCols" style="width:450px">
                        <table class="contacts" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="contact" width="50%">
                                    <form:select id="indicator_id" path="indicatorId" items="${cols}" cssClass="componentSize"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="contact" width="50%">(*) <fmt:message key="scientificname"/></td>
                                <td class="contact" width="50%">
                                    <form:select id="scientific_name" path="taxonScientificName" items="${cols}" cssClass="componentSize"/>
                                </td>
                            </tr>
                        </table>
