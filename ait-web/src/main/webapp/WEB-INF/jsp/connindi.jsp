<%-- 
    Document   : connindi
    Created on : Jul 8, 2010, 3:41:42 PM
    Author     : esmata
--%>
...
<html>
    ...
    <body>
        ...
        <div id="contenido">
            ...
            <div id="content">
                <h2><fmt:message key="indi_mapping_connection"/></h2><br>
                ...
                <form:form method="POST" commandName="connection" cssStyle="margin:0">
                    ...
                    <div id="buttons">
                        ...
                        <input type="button" class="simple_button" id="saveConnAttributes" value="<fmt:message key="test_conn"/>" onclick="verifyIndi()"/>
                    </div><br>
                </form:form>
            </div>
