<%-- 
    Document   : conntindi
    Created on : Jul 9, 2010, 12:23:20 PM
    Author     : esmata
--%>
...
<html>
    ...
    <body>
        ...
        <div id="contenido">
            ...
            <div id="content">
                <h2><fmt:message key="tindi_mapping_connection"/></h2><br>
                ...
                <form:form method="POST" commandName="connection" cssStyle="margin:0">
                    ...
                    <div id="buttons">
                        ...
                        <input type="button" class="simple_button" id="saveConnAttributes" value="<fmt:message key="test_conn"/>" onclick="verifyTindi()"/>
                    </div><br>
                </form:form>
            </div>
