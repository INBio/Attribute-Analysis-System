 ...
 * @author esmata
 */
public class ConncountryController extends SimpleFormController{
     ...
     */
    public ConncountryController() {
        setCommandClass(CountryPropertyHolder.class);
    ...
    protected Object formBackingObject(HttpServletRequest request) throws Exception {
        CountryPropertyHolder cph = (CountryPropertyHolder) super.formBackingObject(request);
        cph = configManager.getCountryPropertyHolder();
        return cph;
    }
    ...
    protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response,
		...
		CountryPropertyHolder connection = (CountryPropertyHolder) command;

        //Persist the connection attributes
        boolean savePropertiesOk = this.configManager.saveToPropertiesFileCountry(connection);
        //Retrive a total count from db for the specified table (test)
        int total = this.configManager.CountCountry();
