 ...
 * @author esmata
 */
public class ConnindiController extends SimpleFormController{
     ...
     */
    public ConnindiController() {
        setCommandClass(IndiPropertyHolder.class);
    ...
    protected Object formBackingObject(HttpServletRequest request) throws Exception {
        IndiPropertyHolder iph = (IndiPropertyHolder) super.formBackingObject(request);
        iph = configManager.getIndiPropertyHolder();
        return iph;
    }
    ...
    protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response,
		...
		IndiPropertyHolder connection = (IndiPropertyHolder) command;

        //Persist the connection attributes
        boolean savePropertiesOk = this.configManager.saveToPropertiesFileIndi(connection);
        //Retrive a total count from db for the specified table (test)
        int total = this.configManager.CountIndi();
